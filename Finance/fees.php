<?php
    ...
    if(isset($_POST['save']))
    {
        // link variables to posted values
    ...
    {
        $errormsg = "<div class='alert alert-success'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><strong>Success!</strong> Fees Payment Submitted successfully</div>";
    }
...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Fees Details</h1>
                    </div>
                </div>
                <?php
                    echo $errormsg;
                        ...
                        function mydatatable()
                            {
                                $("#subjectresult").html('<table class="table table-striped table-bordered table-hover" id="tSortable22"><thead><tr><th>Name/Contact</th><th>Fees</th><th>Balance</th><th>Branch</th><th>DOJ</th><th>Action</th></tr></thead><tbody></tbody></table>');                              
                                    $("#tSortable22").dataTable({
                                        ...
                                        'bProcessing' : true,
                                        'bServerSide': true,
                                        'sAjaxSource': "../../data-tables/datatable.php?"+$('#searchform').serialize()+"&type=feesearch",
                                        'aoColumnDefs': [{
                                            'bSortable': false,
                            ...
                            $("#tSortable22").dataTable({
                                ...
                                'bProcessing' : true,
                                'bServerSide': true,
                                'sAjaxSource': "../../data-tables/datatable.php?type=feesearch",                                          
                                'aoColumnDefs': [{
                                    'bSortable': false,
                                    'aTargets': [-1] /* 1st one, start by the right */
                                }]
